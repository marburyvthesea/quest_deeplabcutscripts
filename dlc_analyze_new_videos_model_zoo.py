...
deeplabcut.create_pretrained_project(path_config_file, "JJM", avi_list, model="superanimal_topviewmouse", working_directory=r"/projects/b1118/dlc_analysis", copy_videos=False,  videotype='.avi', analyzevideo=True, filtered=True, createlabeledvideo=True, trainFraction=None)
...
#this may not work if we can't find the original videos
